...
public class HomepageController {
    ...
    public String homepage(Model model){
        List<SellerAdvertisement> seller_ads = sellerAdvertisementService.findAllByStatus(0);
        ...
        List<ProductAdvertisement> pro_ads_roll = productAdvertisementService.findAllByType(1);
        ...
        List<ProductAdvertisement> pro_ads_list = productAdvertisementService.findAllByType(2);
